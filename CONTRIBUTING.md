...
Utilize o comando `git checkout -b` ou  `feat/community/seunomedeusuario`, para criar e alternar para a nova branch e nomeie-a como `feat/community/SEU_USERNAME`
